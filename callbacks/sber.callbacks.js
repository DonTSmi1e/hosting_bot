...
module.exports = async (ctx) => {
    ...
    await ctx.editMessageText(`🟢 <b>Сбербанк</b> 🟢
<b>Номер карты:</b> <code>${settings.sber}</code>
...
После произведенной оплаты нажмите кнопку <b>Подтвердить платеж</b> чтобы уведомить администраторов.`, {
        ...
        ...Markup.inlineKeyboard([
            [ Markup.button.callback('Подтвердить платеж', `accept:sber:${ctx.from.id}:${ctx.from.username}`) ],
